...
IUSE="big-endian bluetooth build examples gdbm hardened lto +ncurses pgo +readline +sqlite +ssl test tk wininst +xml"
RESTRICT="!test? ( test )"
...
src_configure() {
	...
	local myeconfargs=(
		...
		ax_cv_c_float_words_bigendian=$(usex big-endian)
