...
SRC_URI="
	...
	${XANMOD_URI}/5.14.5-xanmod${XANMOD_VERSION}-cacule/patch-5.14.5-xanmod${XANMOD_VERSION}-cacule.xz
	${GENPATCHES_URI}
"

src_unpack() {
UNIPATCH_LIST_DEFAULT=""
		UNIPATCH_LIST="${DISTDIR}/patch-5.14.5-xanmod${XANMOD_VERSION}-cacule.xz
