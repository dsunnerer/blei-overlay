...
SRC_URI="
	...
	${XANMOD_URI}/5.14.12-xanmod${XANMOD_VERSION}-cacule/patch-5.14.12-xanmod${XANMOD_VERSION}-cacule.xz
	${GENPATCHES_URI}
"

src_unpack() {
UNIPATCH_LIST_DEFAULT=""
		UNIPATCH_LIST="${DISTDIR}/patch-5.14.12-xanmod${XANMOD_VERSION}-cacule.xz
	...
	sed -i 's/SUBLEVEL = 12/SUBLEVEL = 13/' "${S}/Makefile"
}
