...
UNIPATCH_LIST_DEFAULT=""
						...
						#${FILESDIR}/cachy-patches/0001-latency-lazy-mm.patch
						...
						#${FILESDIR}/cachy-patches/0001-misc.patch
						#${FILESDIR}/cachy-patches/0001-pf-patches.patch
		CACHY_PATCHES="${FILESDIR}/cachy-patches/0001-amd-pstate-v4.patch
						...
						${FILESDIR}/cachy-patches/0001-damon.patch
						...
						${FILESDIR}/cachy-patches/0001-string.patch
...
src_prepare() {
	...
	sed -i 's/SUBLEVEL\s*=\s*0/SUBLEVEL\s*=\s*4/' "${S}"/Makefile
}
