...
UNIPATCH_LIST_DEFAULT=""
		...
		CACHY_PATCHES="${FILESDIR}/cachy-patches/AMD/0001-AMD-PERF-PATCH.patch
						${FILESDIR}/cachy-patches/AMD/0001-amd64-patches.patch
...
src_prepare() {
	...
	sed -i 's/SUBLEVEL\s*=\s*0/SUBLEVEL = 6/' "${S}"/Makefile
}
